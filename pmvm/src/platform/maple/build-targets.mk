...
#OBJS += $(BUILD_PATH)/test.o $(BUILD_PATH)/main.o 

.PHONY: library

$(BUILD_PATH)/$(BOARD).elf: $(BUILDDIRS) $(TGT_BIN) $(OBJS) $(PM_LIB_PATH)
	$(SILENT_LD) $(CXX) $(LDFLAGS) -o $@ $(TGT_BIN) $(OBJS) $(PM_LIB_PATH) -Wl,-Map,$(BUILD_PATH)/$(BOARD).map
