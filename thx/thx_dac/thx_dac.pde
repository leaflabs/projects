/*
 * Generate the THX Deep Note, in stereo, using two DAC outputs and 16 sawtooth
 * waves.
 *
 ...
 * wire up the ground of your headphones/speakers to ground on Maple Mini!
 *
...
#define AUDIO_OUT0_PIN      25  // Left Channel PWM
#define AUDIO_OUT1_PIN      26  // Right Channel PWM
#define RANDOM_SEED_PIN      3  // Analog Pin to sample for entropy
#define AUDIO_RATE          15  // in microseconds
#define CONTROL_RATE     30000  // in microseconds
#define NUM_CHANNELS        16
#define HALF_CHANNELS        8
